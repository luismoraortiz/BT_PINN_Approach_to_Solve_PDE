...
%   The Problem is the LID-DRIVEN CAVITY FLOW
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% This problem solves the LID-DRIVEN CAVITY FLOW problem with velocity
% formulation. It is non-optimal. It has two solutions for different Re
% available in the .mat file "Report_NSE_Re1.mat" and "Report_NSE_Re50.mat"
% It has been defined as a TWO-staged optimization.
...
y0PC = ymin*ones(1,pnum);
x0PC = linspace(ymin,ymax,pnum);
p0PC = zeros(1,pnum);
...
%% Considering the meshing distribution
figure
hold on
plot(xpts, ypts, 'b*')
plot(x0BC1,y0BC1,'ro');
...
%% This is the Checkmark for Results
% Load the .mat file here and run the code below for results
...
clf
subplot(1,3,1)
contourf(Xx,Yy,Uu,50)
hold on
contour3(Xx,Yy,Uu,50);
hold off
...
%
function [loss,gradientsV] = objectiveFunction1(parametersU,dlXBC,dlYBC,dlUBC,dlVBC,dlXBC1,dlYBC1,dlUBC1,dlVBC1,dlXBC2,dlYBC2,dlUBC2,dlVBC2,dlXBC3,dlYBC3,dlUBC3,dlVBC3,dlXBC4,dlYBC4,dlUBC4,dlVBC4,dlXP,dlYP,dlPP,dlX,dlY,parameterNames,parameterSizes)
    % Rate of Decay
    a = 0.9;
    ...
    [gradients,loss] = dlfeval(@modelGradients1,parametersu,dlXBC,dlYBC,dlUBC,dlVBC,dlXBC1,dlYBC1,dlUBC1,dlVBC1,dlXBC2,dlYBC2,dlUBC2,dlVBC2,dlXBC3,dlYBC3,dlUBC3,dlVBC3,dlXBC4,dlYBC4,dlUBC4,dlVBC4,dlXP,dlYP,dlPP,dlX,dlY);
    % Return loss and gradients for fmincon.
    gradientsV = parameterStructToVector(gradients);
    gradientsV = a*extractdata(gradientsV);
    loss = extractdata(loss);
end
function [loss,gradientsV] = objectiveFunction2(parametersU,dlXBC,dlYBC,dlUBC,dlVBC,dlXBC1,dlYBC1,dlUBC1,dlVBC1,dlXBC2,dlYBC2,dlUBC2,dlVBC2,dlXBC3,dlYBC3,dlUBC3,dlVBC3,dlXBC4,dlYBC4,dlUBC4,dlVBC4,dlXP,dlYP,dlPP,dlX,dlY,parameterNames,parameterSizes)
    % Rate of Decay
    a = 0.9;
    % Convert parameters to structure of dlarray objects.
    parametersU = dlarray(parametersU);
    parametersu = parameterVectorToStruct(parametersU,parameterNames,parameterSizes);
    % Evaluate model gradients and loss.
    [gradients,loss] = dlfeval(@modelGradients2,parametersu,dlXBC,dlYBC,dlUBC,dlVBC,dlXBC1,dlYBC1,dlUBC1,dlVBC1,dlXBC2,dlYBC2,dlUBC2,dlVBC2,dlXBC3,dlYBC3,dlUBC3,dlVBC3,dlXBC4,dlYBC4,dlUBC4,dlVBC4,dlXP,dlYP,dlPP,dlX,dlY);
    % Return loss and gradients for fmincon.
    gradientsV = parameterStructToVector(gradients);
    gradientsV = a*extractdata(gradientsV);
    loss = extractdata(loss);
...
%
function [gradients,loss] = modelGradients1(parameters,dlXBC,dlYBC,dlUBC,dlVBC,dlXBC1,dlYBC1,dlUBC1,dlVBC1,dlXBC2,dlYBC2,dlUBC2,dlVBC2,dlXBC3,dlYBC3,dlUBC3,dlVBC3,dlXBC4,dlYBC4,dlUBC4,dlVBC4,dlXP,dlYP,dlPP,dlX,dlY)
    ...
    dlUBCPred = model(parameters,dlXBC1,dlYBC1,1);
    dlVBCPred = model(parameters,dlXBC1,dlYBC1,2);
    lossU1 = mse(dlUBCPred, dlUBC1);
    lossV1 = mse(dlVBCPred, dlVBC1);
    dlUBCPred = model(parameters,dlXBC2,dlYBC2,1);
    dlVBCPred = model(parameters,dlXBC2,dlYBC2,2);
    lossU2 = mse(dlUBCPred, dlUBC2);
    lossV2 = mse(dlVBCPred, dlVBC2);
    dlUBCPred = model(parameters,dlXBC3,dlYBC3,1);
    dlVBCPred = model(parameters,dlXBC3,dlYBC3,2);
    lossU3 = mse(dlUBCPred, dlUBC3);
    lossV3 = mse(dlVBCPred, dlVBC3);
    dlUBCPred = model(parameters,dlXBC4,dlYBC4,1);
    dlVBCPred = model(parameters,dlXBC4,dlYBC4,2);
    lossU4 = mse(dlUBCPred, dlUBC4);
    lossV4 = mse(dlVBCPred, dlVBC4);
    % Combine losses.
    loss = lossP + lossU1 + lossV1 + lossU2 + lossV2 + lossU3 + lossV3 + lossU4 + lossV4;
    % Calculate gradients with respect to the learnable parameters.
    gradients = dlgradient(loss,parameters);
end
function [gradients,loss] = modelGradients2(parameters,dlXBC,dlYBC,dlUBC,dlVBC,dlXBC1,dlYBC1,dlUBC1,dlVBC1,dlXBC2,dlYBC2,dlUBC2,dlVBC2,dlXBC3,dlYBC3,dlUBC3,dlVBC3,dlXBC4,dlYBC4,dlUBC4,dlVBC4,dlXP,dlYP,dlPP,dlX,dlY)
    ...
    lossV4 = mse(dlVBCPred, dlVBC4);
    % Combine losses.
    loss = (lossF + lossG + lossH)*100 + lossP + ...
        + lossU1 + lossV1 + lossU2 + lossV2 + lossU3 + lossV3 + lossU4 + lossV4;
    % Calculate gradients with respect to the learnable parameters.
    gradients = dlgradient(loss,parameters);
end
%
...
dlXBC1 = dlarray(in.XBC1,'CB');
dlYBC1 = dlarray(in.YBC1,'CB');
dlUBC1 = dlarray(in.UBC1,'CB');
dlVBC1 = dlarray(in.VBC1,'CB');
dlXBC2 = dlarray(in.XBC2,'CB');
dlYBC2 = dlarray(in.YBC2,'CB');
dlUBC2 = dlarray(in.UBC2,'CB');
dlVBC2 = dlarray(in.VBC2,'CB');
dlXBC3 = dlarray(in.XBC3,'CB');
dlYBC3 = dlarray(in.YBC3,'CB');
dlUBC3 = dlarray(in.UBC3,'CB');
dlVBC3 = dlarray(in.VBC3,'CB');
dlXBC4 = dlarray(in.XBC4,'CB');
dlYBC4 = dlarray(in.YBC4,'CB');
dlUBC4 = dlarray(in.UBC4,'CB');
dlVBC4 = dlarray(in.VBC4,'CB');
% Pressure Conditions (PC)
...
objFun = @(parameters) objectiveFunction1(parameters,dlXBC,dlYBC,dlUBC,dlVBC,...
    dlXBC1,dlYBC1,dlUBC1,dlVBC1,dlXBC2,dlYBC2,dlUBC2,dlVBC2,...
    dlXBC3,dlYBC3,dlUBC3,dlVBC3,dlXBC4,dlYBC4,dlUBC4,dlVBC4,...
