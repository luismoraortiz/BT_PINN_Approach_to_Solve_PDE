...
% This is the baseline version for the Poiseuille flow regime, which is a
...
% Poiseuille_Flow.mat" which contains one successful solution to the problem
...
u0BC1 = -4*y0BC1.*(y0BC1-1);
u0BC2 = -4*y0BC2.*(y0BC2-1);
v0BC1 = zeros(1,ynum);
v0BC2 = zeros(1,ynum);
...
% Load the document "Report_Poiseuille.mat" if results is what you seek.
