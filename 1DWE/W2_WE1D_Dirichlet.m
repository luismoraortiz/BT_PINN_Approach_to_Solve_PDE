...
% This corresponds to an elementary resolution of the problem and its
% comparison to the actual expected solution.

%% Part 0.- Starting the Program and General Definitions
% Could be commented due to the large runtime of the algorithm
clear; clc; close all;

%% Part I.- Describe the Training Data
...
for i=1:numel(tTest)
    ...
    alpha = 5^2; k = 0.01;
    UTest = solveWaveEquation(XTest,t,alpha,k);
    % Calculate error.
...
subplot(3,2,6)
legend('PINN Neural Network','Expected Solution',...
...
function [gradients,loss] = modelGradients(parameters,dlX,dlT,dlXIC,dlTIC,dlUIC,dlXBC,dlTBC,dlUBC)
    ...
    % Assume a value for the parameter c
    c = 0.01;
